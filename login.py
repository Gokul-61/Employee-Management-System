...
def login():
    ...
    elif usernameEntry.get() == 'Gopika' and passwordEntry.get() == '1606':
        messagebox.showinfo('Success','Welcome Gopika')
        window.destroy()
        import ems
...
backgroundImage = ImageTk.PhotoImage(file='images/bg.png')
